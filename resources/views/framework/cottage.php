...
<body>
                        ...
                        <div class="classy-menu" id="navbarResponsive">
                            ...
                            <div class="classynav" id="mynav">
                                <ul>
                                    ...
                                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="/room">Rooms</a></li>
    ...
    <div class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/cottage-double-2.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        <h2 class="room-title">Cottage Room</h2>
                        <h2 class="room-price">Rp.320.000 <span>/ Per Night</span></h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="single-room-details-area mb-50">
                            ...
                            <div id="room-thumbnail--slide" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="img/bg-img/cottage-double-3.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="img/bg-img/cottage-twin-2.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="img/bg-img/cottage-table.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="img/bg-img/cottage-bathroom-1.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="img/bg-img/cottage-bathroom-2.jpg" class="d-block w-100" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="room-service mb-50">
                            ...
                            <ul>
                                ...
                                <li><img src="img/core-img/icon3.png" alt=""> Restaurant Order</li>
                    ...
                    <div class="col-12 col-sm-4 col-lg-2">
                        <div class="single-footer-widget mb-80" id="robertoNav">
                            ...
                            <ul class="footer-nav">
                                ...
                                <li><a class="nav-link js-scroll-trigger" href="/rooms">Rooms</a></li>
